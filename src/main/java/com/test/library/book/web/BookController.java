...
public class BookController {
    ...
    @Operation(summary = "책 전체 조회", description = "책 전체 조회")
    ...
    @Operation(summary = "책 단건 조회", description = "책 단건 조회")
    public ResponseEntity<BookDTO> getBookById(@PathVariable Long bookUid) {
    ...
    @Operation(summary = "책 등록", description = "책 등록")
    ...
    @Operation(summary = "책 수정", description = "책 수정")
    public ResponseEntity<BookDTO> updateBook(@PathVariable Long bookUid, @RequestBody BookDTO bookDTO) {
    ...
    @Operation(summary = "책 삭제", description = "책 삭제")
    public ResponseEntity<Void> deleteBook(@PathVariable Long bookUid) {

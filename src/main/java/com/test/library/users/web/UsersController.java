...
public class UsersController {
    ...
    @Operation(summary = "사용자 전체 조회", description = "사용자 전체 조회")
    ...
    @Operation(summary = "사용자 단건 조회", description = "사용자 단건 조회")
    public ResponseEntity<UsersDTO> getUsersById(@PathVariable Long usersUid) {
    ...
    public ResponseEntity<UsersDTO> updateUsers(@PathVariable Long usersUid, @RequestBody UsersDTO usersDTO) {
    ...
    public ResponseEntity<Void> deleteUsers(@PathVariable Long usersUid) {
